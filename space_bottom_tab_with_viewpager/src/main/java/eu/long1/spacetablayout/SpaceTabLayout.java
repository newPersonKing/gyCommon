...
public class SpaceTabLayout extends RelativeLayout {
    ...
    private void getTab(){
        for(int i=0;i<numberOfTabs;i++){
            if(i==0){
                tabOne = tabLayout.getTabAt(i);
                tabs.add(tabOne);
            }else if(i==1){
                tabTwo = tabLayout.getTabAt(i);
                tabs.add(tabTwo);
            }else if(i==2){
                tabThree = tabLayout.getTabAt(i);
                tabs.add(tabThree);
            }else if(i==3){
                tabFour = tabLayout.getTabAt(i);
                tabs.add(tabFour);
            }else if(i==4){
                tabFive = tabLayout.getTabAt(i);
                tabs.add(tabFive);
            }
        }
    }
    ...
    private void getImageView(){
        ...
        if(tabFour!=null){
            tabFourImageView =  tabThree.getCustomView().findViewById(R.id.tabImageView);
        }
        if(tabFive!=null){
            tabFiveImageView =  tabThree.getCustomView().findViewById(R.id.tabImageView);
        }
    }
    ...
    public void setTabOneText(String tabOneText) {
        Log.i("ccccccccccccc","tabOneTextView=="+iconOnly);
    ...
    public void setTabFourText(String tabThreeText) {
        if (!iconOnly) tabThreeTextView.setText(tabThreeText);
        else throw new IllegalArgumentException("You selected icons only.");
    }

    public void setTabFourText(@StringRes int tabThreeText) {
        if (!iconOnly) tabThreeTextView.setText(tabThreeText);
        else throw new IllegalArgumentException("You selected icons only.");
    }

    public void setTabFiveText(String tabThreeText) {
        if (!iconOnly) tabThreeTextView.setText(tabThreeText);
        else throw new IllegalArgumentException("You selected icons only.");
    }

    public void setTabFiveText(@StringRes int tabThreeText) {
        if (!iconOnly) tabThreeTextView.setText(tabThreeText);
        else throw new IllegalArgumentException("You selected icons only.");
    }
